...
from jeti.module_utils.common._collections_compat import MutableMapping, MutableSet, MutableSequence
...
def get_versioned_doclink(path):
    ...
    (eg, https://docs.ansible.com/jeti/2.8/somepath/doc.html)
