...
from jeti.module_utils.common._collections_compat import Mapping, Set
from jeti.module_utils.common.collections import is_sequence
...
class UnsafeProxy(object):
    def __new__(cls, obj, *args, **kwargs):
        ...
        Display().deprecated(
            'UnsafeProxy is being deprecated. Use wrap_var or AnsibleUnsafeBytes/jetiUnsafeText directly instead',
            version='2.13'
        )
